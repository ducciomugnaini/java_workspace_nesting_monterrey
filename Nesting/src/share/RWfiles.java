...
public class RWfiles {
	...
	public ArrayList<String> leerProblemas(File archivo)throws FileNotFoundException,IOException{
	...
	public int[][] obtenerMatriz(File archivo, int maxvalue) throws FileNotFoundException,IOException{
		BufferedReader lector = new BufferedReader(new FileReader(archivo));
	...
	public void archivoSalida(File archivo0, File archivo1, List<String> Problem, double[][] apt, int[][] obj, int[][] exTimes, int[] indices, int indice) throws FileNotFoundException,IOException{
