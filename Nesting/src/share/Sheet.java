...
public class Sheet 
{
	...
	private int Nopiezas;  //Number of pieces placed until now
    ...
    // Adds a piece provisionally into the object (skip angles, areas, points, etc).
	// If it turns to a definite piece, it should be removed as preliminary and
	// added as a regular piece of the object (with addPieza)
	// This method is employed in the DJD heuristic.
